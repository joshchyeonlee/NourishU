...
VALUES("josh", "josh@nourishu.com", '1997-02-01', 170, 70, 73, "Bean Eater", "Eat the bean", 5, "bean");`;
const addUser1 = `
INSERT INTO USER(UserName, UserEmail, UserBirthdate, UserHeight, UserWeight, UserAge, DietName, DietDescription, CookingConfidence, UserPassword)
VALUES("notJosh", "notjosh@nourishu.com", '1965-03-15', 190, 83, 13, "Carnivore", "Dude eat some veggies", 3, "bean1");`;
const addUser2 = `
INSERT INTO USER(UserName, UserEmail, UserBirthdate, UserHeight, UserWeight, UserAge, DietName, DietDescription, CookingConfidence, UserPassword)
VALUES("definitelynotjosh", "whodis@nourishu.com", '1995-12-31', 154, 49, 28, "Vegetarian", "No meat, only bean", 5, "notjosh");`;
const addUser3 = `
INSERT INTO USER(UserName, UserEmail, UserBirthdate, UserHeight, UserWeight, UserAge, DietName, DietDescription, CookingConfidence, UserPassword)
VALUES("therealjosh", "josh4realz@nourishu.com", '1998-04-29', 169, 69, 25, "Carnivore", "No bean", 1, "beans");`;
const addUser4 = `
INSERT INTO USER(UserName, UserEmail, UserBirthdate, UserHeight, UserWeight, UserAge, DietName, DietDescription, CookingConfidence, UserPassword)
VALUES("beanman3000", "bean@nourishu.com", '1832-02-01', 300, 300, 420, "Bean Eater", "Eat the bean", 3, "beaned");`;
