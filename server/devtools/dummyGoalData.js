...
VALUES(0, 1, 0, "get ripped", 10, "In Progress");`;
const user1Goal = `
INSERT INTO GOAL(UserID, GoalMilestone, GoalID, GoalName, GoalDuration, GoalProgress)
VALUES(1, 1, 1, "get shredded", 1, "In Progress");`;
const user2Goal = `
INSERT INTO GOAL(UserID, GoalMilestone, GoalID, GoalName, GoalDuration, GoalProgress)
VALUES(2, 1, 2, "eat more", 3, "In Progress");`;
const user3Goal = `
INSERT INTO GOAL(UserID, GoalMilestone, GoalID, GoalName, GoalDuration, GoalProgress)
VALUES(3, 1, 3, "eat bean", 4, "In Progress");`;
const user4Goal = `
INSERT INTO GOAL(UserID, GoalMilestone, GoalID, GoalName, GoalDuration, GoalProgress)
VALUES(4, 1, 4, "eat cheese", 20, "In Progress");`;
const user4Goal1 = `
INSERT INTO GOAL(UserID, GoalMilestone, GoalID, GoalName, GoalDuration, GoalProgress)
VALUES(4, 1, 5, "rip bean", 10, "In Progress");`;
